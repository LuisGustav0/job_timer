...
const ProjectSchema = CollectionSchema(
  name: 'Project',
  schema:
      '{"name":"Project","idName":"id","properties":[{"name":"name","type":"String"},{"name":"statusE","type":"Long"}],"indexes":[],"links":[{"name":"listTask","target":"ProjectTask"}]}',
  idName: 'id',
  propertyIds: {'name': 0, 'statusE': 1},
  listProperties: {},
  indexIds: {},
  indexValueTypes: {},
  linkIds: {'listTask': 0},
...
void _projectSerializeNative(
  ...
  final value1 = _projectProjectStatusConverter.toIsar(object.statusE);
  final _statusE = value1;
  ...
  writer.writeLong(offsets[1], _statusE);
}
