...
const ProjectSchema = CollectionSchema(
  name: 'Project',
  schema:
      '{"name":"Project","idName":"id","properties":[{"name":"estimate","type":"Long"},{"name":"name","type":"String"},{"name":"statusE","type":"Long"}],"indexes":[],"links":[{"name":"listTask","target":"ProjectTask"}]}',
  idName: 'id',
  propertyIds: {'estimate': 0, 'name': 1, 'statusE': 2},
  listProperties: {},
  indexIds: {},
  indexValueTypes: {},
  linkIds: {'listTask': 0},
...
void _projectSerializeNative(
  ...
  final value2 = _projectProjectStatusConverter.toIsar(object.statusE);
  final _statusE = value2;
  ...
  writer.writeLong(offsets[2], _statusE);
}
...
dynamic _projectSerializeWeb(
  ...
  IsarNative.jsObjectSet(
      jsObj, 'statusE', _projectProjectStatusConverter.toIsar(object.statusE));
  return jsObj;
}
...
Project _projectDeserializeWeb(
  ...
  object.statusE = _projectProjectStatusConverter.fromIsar(
      IsarNative.jsObjectGet(jsObj, 'statusE') ?? double.negativeInfinity);
  ...
  switch (propertyName) {
    ...
    case 'statusE':
      return (_projectProjectStatusConverter.fromIsar(
          IsarNative.jsObjectGet(jsObj, 'statusE') ??
              double.negativeInfinity)) as P;
    default:
...
void _projectAttachLinks(IsarCollection col, int id, Project object) {
  object.listTask.attach(col, col.isar.projectTasks, 'listTask', id);
}
...
extension ProjectQueryFilter
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> statusEEqualTo(
      ProjectStatusE value) {
    return addFilterConditionInternal(FilterCondition(
      type: ConditionType.eq,
      property: 'statusE',
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> statusEGreaterThan(
    ProjectStatusE value, {
    bool include = false,
  }) {
    return addFilterConditionInternal(FilterCondition(
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> statusELessThan(
    ProjectStatusE value, {
    bool include = false,
  }) {
    return addFilterConditionInternal(FilterCondition(
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> statusEBetween(
    ProjectStatusE lower,
    ProjectStatusE upper, {
    bool includeLower = true,
    bool includeUpper = true,
  }) {
    return addFilterConditionInternal(FilterCondition.between(
...
extension ProjectQueryLinks
    on QueryBuilder<Project, Project, QFilterCondition> {
  QueryBuilder<Project, Project, QAfterFilterCondition> listTask(
...
extension ProjectQueryWhereSortBy on QueryBuilder<Project, Project, QSortBy> {
  ...
  QueryBuilder<Project, Project, QAfterSortBy> sortByStatusE() {
    return addSortByInternal('statusE', Sort.asc);
  }

  QueryBuilder<Project, Project, QAfterSortBy> sortByStatusEDesc() {
    return addSortByInternal('statusE', Sort.desc);
  }
}
...
extension ProjectQueryWhereSortThenBy
  ...
  QueryBuilder<Project, Project, QAfterSortBy> thenByStatusE() {
    return addSortByInternal('statusE', Sort.asc);
  }

  QueryBuilder<Project, Project, QAfterSortBy> thenByStatusEDesc() {
    return addSortByInternal('statusE', Sort.desc);
  }
}
...
extension ProjectQueryWhereDistinct
  ...
  QueryBuilder<Project, Project, QDistinct> distinctByStatusE() {
    return addDistinctByInternal('statusE');
  }
}
...
extension ProjectQueryProperty
  ...
  QueryBuilder<Project, ProjectStatusE, QQueryOperations> statusEProperty() {
    return addPropertyNameInternal('statusE');
  }
}
